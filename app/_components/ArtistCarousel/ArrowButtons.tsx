...
export const NextButton: React.FC<ButtonPropType> = props => {
  ...
  return (
    <button
      className="artistCarousel__button artistCarousel__button--next"
      type="button"
      {...restProps}
    >
      <svg aria-hidden className="artistCarousel__button__svg" viewBox="0 0 532 532">
        <path
...
export const PrevButton: React.FC<ButtonPropType> = props => {
  ...
  return (
    <button
      className="artistCarousel__button artistCarousel__button--prev"
      type="button"
      {...restProps}
    >
      <svg aria-hidden className="artistCarousel__button__svg" viewBox="0 0 532 532">
